...
乳児の便試料において、採取時期別に色分けしたスコアプロットを作成したところ、成長に伴う明確なクラスターの形成が認められた。具体的には、第1主成分（PC1）の寄与により、日齢の低い「出産直後（Newborn）」群と、離乳が進んだ「産後1.5年（Aft. 1.5 yrs.）」、「産後3年（Aft. 3 yrs.）」、「産後5年（Aft. 5 yrs.）」の各群が、それぞれクラスターを形成して分布していた。
