...
母乳中メタボロームを可視化するため、濃度定量値をもとにPCAを実施した（@fig-bmPCA）。スコアプロットを母乳の採取時期別に色分けした結果、初乳・産後1ヶ月・産後4-5ヶ月の各群でクラスターの形成が確認できた。これらのクラスターは第1主成分・第2主成分が初乳とその他の群の分離に寄与しており、ローディングプロットにおいて、2'-fucosyllactose (2'-FL）、3'-sialyllactose、6'-sialyllactoseなどのヒトミルクオリゴ糖（HMOs）が初乳群の特徴的な代謝物であった。一方産後1ヶ月・産後4-5ヶ月群では、Lactoseなどエネルギーの供給源となる代謝物や、Caprate、Caprylateなどの中鎖脂肪酸が特徴的であった。また、産後1ヶ月群と産後4-5ヶ月群の分離には、第3主成分が寄与しており、HMOsの一種である3-fucosyllactose（3-FL）やLactate・Pyruvateなどの短鎖脂肪酸が産後1ヶ月群で、CitrateやO-phosphocholineが産後4-5ヶ月に特徴的な代謝物であった。
// fig-bmPCAのレイアウトを修正。
HMOs
