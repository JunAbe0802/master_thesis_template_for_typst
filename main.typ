...
母乳メタボロームは産後の経過に伴い動的に変動し、初乳ではHMOsが、産後数ヶ月では脂肪酸が高値を示した 。分泌型別解析では、Se+群で2'-FLとfucoseが、Se-群では3-FLが有意に高かった 。これはFUT2とFUT3による基質の競合的利用による影響を示唆している 。 乳児便中メタボロームも成長に伴い変化し、産後早期には未消化のlactoseや単糖類が高値であった 。特筆すべき点として、Se+群の乳児便では2'-FLに加え、粉ミルク由来のlactuloseが有意に蓄積していた 。これは豊富なHMOsが優先的に細菌に利用された結果、lactuloseの消費が抑制された可能性を示唆している 。
...
また、Se+群で fucose が高値であった理由については、Se-群での生成制限といったフィードバック機構やSe+群での分解亢進の関与が想定され、これにはトランスクリプトーム解析等を用いた分子レベルでの追究が求められる。なお、fucose代謝に関連する成分以外に顕著な差異が見られなかった。Se+/Se-の差異は母乳メタボロームだけでなく体内の糖鎖修飾などに影響を及ぼし、感染症や慢性炎症性疾患を含む様々な疾患と関連している。そのためfucose関連代謝以外への影響が懸念されたが、母乳メタボローム全体における影響は、主要な HMOs の組成変化に限定的であることを示していると考えられる。

母親便中メタボロームが産後時期を通じて変動が小さかったのに対し、乳児便中メタボロームは動的な変遷が起きていた。特に産後早期の乳児便において lactose、glucose、galactose が高値を示した点は注目に値する。乳児の消化吸収機構は出生直後は未熟であり、離乳に向けて徐々に成熟していく @TengTianXinShengErQiRuYinQiLiRuQiniokeruChangnoXiShouJiGou2010。母乳中の主要な糖成分である lactose は、小腸微絨毛膜のラクターゼにより加水分解されるが、消化機能が未発達な時期には未分解の lactose やその分解産物である単糖類が完全に吸収されず、便中へと排出された結果であると考えられる。
...
= 結論
本研究では、SMILE Iwamizawaコホートの母乳および母子便試料のNMRメタボローム解析を通じ、授乳期における代謝動態を包括的に明らかにした 。
...
また、母親の2'–FL分泌型/非分泌型の差異が母乳中のHMO組成を決定づけるだけでなく、離乳前の乳児便中の2'-FL、3-FL、lactulose等の代謝物プロファイルにも顕著な差をもたらすことを突き止めた 。
