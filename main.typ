...
= 結果
== 母乳中代謝物の同定・定量<sec5.1>
実際に得られたNMRスペクトルの一例を@fig1 に示す。全てのサンプルについて、良好なNMRスペクトルを得た。代謝物の同定はピークの組み合わせによって決定され、合計51種類の代謝物を同定・定量した。これらすべての代謝物の平均濃度は@fig2 に示すとおりである。
...
== 産後時期別の母乳代謝物プロファイルの解析<sec5.3>
母乳中代謝物プロファイルを可視化するため、濃度定量値をもとにPCAを実施した（@fig4）。スコアプロットを母乳の採取時期別に色分けした結果、初乳・産後1ヶ月・産後4-5ヶ月の各群でクラスターの形成が確認できた。これらのクラスターは第1主成分・第2主成分が初乳とその他の群の分離に寄与しており、ローディングプロットにおいて、2'-fucosyllactose (2'-FL）、3'-sialyllactose、6'-sialyllactoseなどのヒトミルクオリゴ棟（HMOs）が初乳群の特徴的な代謝物であった一方、Lactoseなどエネルギーの供給源となる代謝部や、Caprate、Caprylateなどの中鎖脂肪酸は、産後1ヶ月・産後4-5ヶ月群で特徴的であった。また、産後1ヶ月群と産後4-5ヶ月群の分離には、第3主成分が寄与しており、HMOsの一種である3-fucosyllactose（3-FL）やLactate・Pyruvateなどの短鎖脂肪酸が産後1ヶ月群で、CitrateやO-phosphocholineが産後4-5ヶ月に特徴的な代謝物であった。
// fig4のレイアウトを修正。
